...
/**
 * <a href="https://docs.oracle.com/javase/specs/jvms/se7/html/jvms-6.html#jvms-6.5.faload">...</a>
 * <p>
 * byte or boolean
 */
public class FALoad implements Instruction {
    ...
    public void execute(StackFrame frame) {
        ...
        frame.getOperandStack().pushFloat((float) arrayObject.getArrayElement(index));
    }

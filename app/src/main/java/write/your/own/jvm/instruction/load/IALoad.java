...
/**
 * <a href="https://docs.oracle.com/javase/specs/jvms/se7/html/jvms-6.html#jvms-6.5.iaload">...</a>
 * <p>
 * byte or boolean
 */
public class IALoad implements Instruction {
    ...
    public void execute(StackFrame frame) {
        ...
        frame.getOperandStack().pushInt((int) arrayObject.getArrayElement(index));
    }

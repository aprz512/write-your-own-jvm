...
/**
 * <a href="https://docs.oracle.com/javase/specs/jvms/se7/html/jvms-6.html#jvms-6.5.laload">...</a>
 * <p>
 * byte or boolean
 */
public class LALoad implements Instruction {
    ...
    public void execute(StackFrame frame) {
        ...
        frame.getOperandStack().pushLong((long) arrayObject.getArrayElement(index));
    }

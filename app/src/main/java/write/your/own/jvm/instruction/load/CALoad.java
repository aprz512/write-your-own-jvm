...
/**
 * <a href="https://docs.oracle.com/javase/specs/jvms/se7/html/jvms-6.html#jvms-6.5.caload">...</a>
 * <p>
 * byte or boolean
 */
public class CALoad implements Instruction {
    ...
    public void execute(StackFrame frame) {
        ...
        frame.getOperandStack().pushInt((char) arrayObject.getArrayElement(index));
    }

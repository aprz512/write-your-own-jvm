...
/**
 * <a href="https://docs.oracle.com/javase/specs/jvms/se7/html/jvms-6.html#jvms-6.5.baload">...</a>
 * <p>
 * byte or boolean
 */
public class BALoad implements Instruction {
    ...
    public void execute(StackFrame frame) {
        ...
        frame.getOperandStack().pushInt((byte) arrayObject.getArrayElement(index));
    }
